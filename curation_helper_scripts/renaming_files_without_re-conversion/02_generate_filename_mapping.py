...
def main():
    ...
    root = Path('/Users/arshitha/Desktop/OneDesk/Projects/17M081_June_2022')
    data = root.joinpath('17M081_jsons')
    ...
    series_to_identifier_df.to_csv('scripts_output/series_descriptions_to_revised_identifiers.csv', quoting=csv.QUOTE_MINIMAL, index=False)
    ...
    with_json_new_to_old_df.to_csv('scripts_output/old_to_new_bids_filename_mapping.csv', quoting=csv.QUOTE_MINIMAL, index=False)
