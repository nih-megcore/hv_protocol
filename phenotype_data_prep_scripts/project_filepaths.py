...
work_dir = Path('/data/rvol/arsh_workspace')
...
id_filepath = data_dir.joinpath('id_files', 'id_linking_20211205_204730.csv')

# cris and ctdb data directories
cris_data_dir = data_dir.joinpath('cris_downloads', '17-M-0181_CRIS_Labs_FINAL.xls')
ctdb_data_dir = data_dir.joinpath('ctdb_downloads', 'CTDB-data-download-20211202-modified.xlsx')
